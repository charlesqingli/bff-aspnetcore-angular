...
public class AccountController : ControllerBase
{
    ...
    // Antiforgery tokens can become invalid after login due to identity change
    // Using IgnoreAntiforgeryToken since Logout requires [Authorize] which provides protection
    [Authorize]
